...
const Nickname = ({ setCurrenStep, setSignInInfo, signInInfo }: INicknameProps) => {
	...
	const checkNickname = async () => {
		const response = await instance.get(`api/user/checknickname?nickname=${signInInfo.nickname}`);
